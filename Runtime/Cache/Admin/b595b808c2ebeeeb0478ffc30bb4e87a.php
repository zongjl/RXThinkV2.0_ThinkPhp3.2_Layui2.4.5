...
<div class="layui-layout layui-layout-admin layui-fluid larryms-layout" id="larry_layout">
	...
	<div class="larryms-body" id="larryms_body">
		...
		<div class="layui-side pos-a larryms-left layui-bg-black" id="larry_left">
			<div class="layui-side-scroll">
                ...
                <div class="user-info">
                    <div class="photo">
                        <img src="<?php if($adminInfo["avatar_url"] != null): echo ($adminInfo["avatar_url"]); else: ?>/Public/Admin/images/logo_mini.png<?php endif; ?>" id="user_photo" alt="">
                    </div>
		...
		<div class="layui-body pos-a larryms-right" id="larry_right">
			<div class="layui-tab larryms-tab" id="larry_tab" lay-filter="larryTab">
                <div class="larryms-title-box clearfix" id="larryms_title">
                    <div class="larryms-btn-default larryms-press larryms-pull-left hide" id="goLeft"><i class="larry-icon yun-arrowDoLRight"></i></div> 
                    ...
                    <div class="larryms-btn-group clearfix">
                        <div class="larryms-btn-default larryms-press larryms-pull-right hide" id="goRight"><i class="larry-icon yun-shuangjiantouyou"></i></div>
	...
	<div class="layui-footer larryms-footer" data-show='on' id="larry_footer">
		 <div class="copyright inline-block pos-al"><a href="javascript:">最终解释权归【RXThink研发团队】所有</a></div>
         <p class="block">研发负责人：相约在冬季(QQ:1175401194)</p>
		 <div class="larryms-info inline-block pos-ar">当前版本：V2.0.0<i class="layui-icon">&#xe67c;</i></a></div>
	</div>
</div>
<!-- 加载js文件-->
